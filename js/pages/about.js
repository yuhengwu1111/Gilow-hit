            ...
            <div class="apple-card p-8 bg-gray-900 text-white rounded-[2rem] mb-12 relative overflow-hidden">
                ...
                <div class="flex justify-between items-center border-t border-gray-800 pt-6 mt-8">
                    ...
                    <div class="flex space-x-2">
                        <button onclick="window.changeSlide(-1)" class="p-2 rounded-full bg-gray-800 hover:bg-gray-700 transition">
                            <i data-lucide="chevron-left" class="w-5 h-5"></i>
                        </button>
                        <button onclick="window.changeSlide(1)" class="p-2 rounded-full bg-blue-600 hover:bg-blue-500 transition">
